...
namespace Efz.Maths {
  ...
  public class CurveVector2 : Curve<Vector2> {
    ...
    public override Vector2 Get(double delta) {
      if(Deltas.Count > 3) {
        int index;
        ...
        case Interpolation.Cubic:
          ...
          Vector2 a0 = Values[index+3] - Values[index+2] - Values[index] + Values[index+1];
          Vector2 a1 = Values[index] - Values[index+1] - a0;
          Vector2 a2 = Values[index+2] - Values[index];
          Vector2 a3 = Values[index+1];
