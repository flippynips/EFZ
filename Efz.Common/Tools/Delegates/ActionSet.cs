...
namespace Efz {
  ...
  public class ActionSet<A,B,C,D,E> :
    ...
    public virtual A ArgA {get;set;}
    public virtual B ArgB {get;set;}
    public virtual C ArgC {get;set;}
    public virtual D ArgD {get;set;}
    public virtual E ArgE {get;set;}
