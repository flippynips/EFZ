...
namespace Alchemy.Classes {
  ...
  public class UserContext {
    ...
    /// <summary>
    /// Called when a connection to the context has been established.
    /// </summary>
    protected OnEventDelegate OnConnectedDelegate = x => { };
    /// <summary>
    /// Called when the context is disconnected.
    /// </summary>
    protected OnEventDelegate OnDisconnectDelegate = x => { };
    /// <summary>
    /// Called when data has been received from the context.
    /// </summary>
    protected OnEventDelegate OnReceiveDelegate = x => { };
    /// <summary>
    /// Called when data is sent to the context.
    /// </summary>
